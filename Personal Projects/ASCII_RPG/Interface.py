...
class Interface:
    ...
    def get_item_from_menu(self, prompt: str, menu_options: [str], zero_option=False) -> str:
        is_selecting = True
        while is_selecting:
            chosen_option = None
            selected_index = 0
            ...
            for menu_option in menu_options:
                print(f"{menu_options.index(menu_option)+1}. {menu_option}")
            chosen_option = input("#> ")
...
def interface_tests():
    ...
    print(interface.get_item_from_menu("Pick an option by entering a number or by typing one of the options.", ["Option 1","Second Choice","Third selection"]))
